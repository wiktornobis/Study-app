...
const Home = () => {
    ...
    useEffect(() => {
       const [elements] = wrapper.current.children;
        ...
        const Paper_6 = elements.getElementById('6_paper');




        if (bottomLine) {
            gsap.set([bottomLine, leftPerson, rightPerson, verticalLine, horizontalLine, Paper_1, Paper_2, Paper_3, Paper_4, Paper_5, Paper_6], { autoAlpha: 0 });
            ...
            tl.fromTo(bottomLine, { x: '-800' }, { duration: 1.5, x: '+=800', autoAlpha: 1 })
                ...
                .fromTo(Paper_6, {y: '0'}, {duration: 1, y: '0', autoAlpha: 1})
        }
